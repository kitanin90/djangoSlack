"""
Django settings for djangoSlack project.
...
SECRET_KEY = 'bd!*ds&68^9hj@q)af-3yuskm1wt7n-dib^c=f-p*$11-yny)j'
...
WSGI_APPLICATION = 'djangoSlack.wsgi.application'
